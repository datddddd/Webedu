...
<footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
  <div class="footer-overlay">
    ...
    $blossom_woocommerce_newsletter = best_shop_get_setting( 'subscription_shortcode' );

    if ( $active_sidebars && $sidebar_count > 0 || $blossom_woocommerce_newsletter !== '' ) {
      ?>
    <div class="footer-top">
      <div class="container">
        <?php

        if ( $blossom_woocommerce_newsletter ) {
          ?>
        <div class="footer-newsletter-section">
          <?php
          the_widget( 'best_shop_newsletter_widget', array( 'newsletter_shortcode' => $blossom_woocommerce_newsletter ) );
          ?>
        </div>
        <?php
