...
<h2 class="wp-block-heading" style="font-size:68px;font-style:normal;font-weight:600"><?php esc_html_e("Discover the Latest trends","blossom-woocommerce"); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-font-size has-medium-font-size"><a class="wp-block-button__link has-vivid-red-background-color has-background wp-element-button" style="border-style:none;border-width:0px;border-radius:0px"><?php esc_html_e("BUY NOW", "blossom-woocommerce"); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
